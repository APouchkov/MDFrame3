inherited SBaseCxTreeViewFrm: TSBaseCxTreeViewFrm
  Left = 151
  Top = 94
  ClientWidth = 845
  ExplicitWidth = 861
    ...
    object PanelLeft: TcxGroupBox
      ...
      object PanelLeftCaption: TPanel
        ...
        object btnTreeTypeChange: TSpeedButton
          ...
          ShowHint = True
          Spacing = 0
          OnClick = btnTreeTypeChangeClick
        end
  ...
  inherited BarManager: TdxMDBarManager
    ...
    object mnTreeChildsIncluded: TdxBarButton [15]
      Category = 0
      Enabled = False
      Visible = ivNever
      ButtonStyle = bsChecked
    ...
    object mnFindInTree: TdxBarButton [16]
      Category = 0
      Enabled = False
      Visible = ivNever
      OnClick = mnFindInTreeClick
    end
