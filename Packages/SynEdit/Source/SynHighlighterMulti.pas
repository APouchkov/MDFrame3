  ...
  while iLine <> '' do
    ...
    begin
      if iScheme.CaseSensitive then
        ...
        LRegExpOptions := [roIgnoreCase];

      LMatches := TRegEx.Matches(iLine, iScheme.EndExpr, LRegExpOptions);
      if LMatches.Count > 0 then begin
        iExpr := Copy(Value, LMatches[0].Index + iEaten, LMatches[0].Length);
        DoCheckMarker(iScheme, LMatches[0].Index + iEaten, LMatches[0].Length, iExpr, False, LineNumber, Value);
        Delete(iLine, 1, LMatches[0].Index - 1 + LMatches[0].Length);
        Inc(iEaten, LMatches[0].Index - 1 + LMatches[0].Length);
        iScheme := nil;
      end
      else
        break;
    ...
    begin
      ...
      begin
        ...
        LMatches := TRegEx.Matches(iLine, iScheme.StartExpr, LRegExpOptions);
        if LMatches.Count > 0 then begin
          iExpr := Copy(Value, LMatches[0].Index + iEaten, LMatches[0].Length);
          DoCheckMarker(iScheme, LMatches[0].Index + iEaten, LMatches[0].Length, iExpr, True, LineNumber, Value);
          Delete(iLine, 1, LMatches[0].Index - 1 + LMatches[0].Length);
          Inc(iEaten, LMatches[0].Index - 1 + LMatches[0].Length);
          break;
        end;
