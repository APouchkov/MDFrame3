...
type
  ...
  published
    property AutoDetectEnabled: Boolean read FAutoDetectEnabled write FAutoDetectEnabled {-=MD=-} default False;
    property AutoDetectLineLimit: Cardinal read FAutoDetectLineLimit write FAutoDetectLineLimit {-=MD=-} default 0;
    ...
    property Visible: Boolean read FVisible write FVisible {-=MD=-} default False;
  end;
