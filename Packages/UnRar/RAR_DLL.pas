...
//  RARProcessFile        : function(hArcData: THandle; Operation: Integer; DestPath, DestName: PAnsiChar): Integer; stdcall;
  RARProcessFileW       : function(hArcData: THandle; Operation: Integer; DestPath, DestName: PWideChar): Integer; stdcall;
...
var
  ...
  lHandle: Cardinal;
begin
  lHandle := FindFirstFileW(PWideChar(S), lFindData);
...
var
  BinaryType: DWord;
begin
  if GetBinaryTypeW(PWideChar(FileName), BinaryType) then begin
