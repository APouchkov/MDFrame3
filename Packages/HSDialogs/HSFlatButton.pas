...
interface
uses
  Types, Windows, Messages, Classes, Graphics, Controls, StdCtrls, Buttons;
...
type
  ...
  published
    ...
    property FocusRectColor : TColor read FFocusRectColor write SetFocusRectColor default clBtnFace;
